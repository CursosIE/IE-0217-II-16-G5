...
El {\bfseries constructor} es una función que se llama igual que la clase \hypertarget{class_fraccion_a3e1003b9ae321c94a95081f5346ab8b8}{\index{Fraccion@{Fraccion}!Fraccion@{Fraccion}}
\index{Fraccion@{Fraccion}!Fraccion@{Fraccion}}
\subsubsection[{Fraccion}]{\setlength{\rightskip}{0pt plus 5cm}Fraccion\+::\+Fraccion (
\begin{DoxyParamCaption}
\item[{double}]{n, }
...
Constructor que recibe los atributos como parámetros \hypertarget{class_fraccion_abb2ec579092e5bc50e7c3644ea718084}{\index{Fraccion@{Fraccion}!````~Fraccion@{$\sim$\+Fraccion}}
...
Método que pertenece a la clase \hyperlink{class_fraccion}{Fraccion} y devuelve un bjeto de tipo \hyperlink{class_fraccion}{Fraccion} 
\begin{DoxyParams}{Parameters}
{\em f2} & objeto de tipo \hyperlink{class_fraccion}{Fraccion} \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Multiplicación de las fracciones dadas 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
División de las fracciones dadas 
\end{DoxyReturn}
...
Método que pertenece a la clase \hyperlink{class_fraccion}{Fraccion}
