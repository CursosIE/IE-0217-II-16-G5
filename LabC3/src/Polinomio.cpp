...
{
	//Método que sobrecarga el operador "+", que pertenece a la clase Polinomio y que devuelve un objeto de tipo Polinomio
	//Recibe objeto de tipo Polinomio
...
{
	//Método que sobrecarga el operador "~", que pertenece a la clase Polinomio y que no devuelve nada
